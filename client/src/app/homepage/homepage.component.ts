...
@Component({
  ...
  standalone: true,
  imports: [CommonModule,NavbarComponent,Interface1Component,TheServicesComponent,CategoriesComponent,PopularCoursesComponent,TutorsComponent,CommentsComponent],
